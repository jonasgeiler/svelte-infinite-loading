...
<nav class="left drawer l">
	...
	<a href="https://github.com/jonasgeiler/svelte-infinite-loading" target="_blank">
		<i aria-hidden="true">
	...
	<a href="https://npmjs.com/package/svelte-infinite-loading" target="_blank">
		<i aria-hidden="true">
			<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				<path
